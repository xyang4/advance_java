...
import com.xyang.lucene.searcher.SearcherUtil;
...
public class TestSearch {
	...
	public void testCopyFiles() {
		try {
			File file = new File("E:/data/lucene/example/");
			for (File f : file.listFiles()) {
				String destFileName = FilenameUtils.getFullPath(f.getAbsolutePath())+ FilenameUtils.getBaseName(f.getName()) + ".she";
	...
	public void testCreateIndexFile() {
		FileIndexUtils.createIndex(true);
	}
